        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://127.0.0.1:3000/v1/admin/kullanici/login",
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "GET",
              url: "http://127.0.0.1:3000/v1/admin/kullanici/logout"
            });
          ...
          case 7:
            ...
            console.log(_context2.t0.response); //burası
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"adminPanelData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateData = exports.deleteData = exports.createData = void 0;
...
var createData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, path) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://127.0.0.1:3000/v1/admin/".concat(path, "/"),
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Kayıt başarıyla alındı");
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
...
var updateData = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "şifreniz başarıyla güncellendi!");
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function updateData(_x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
...
var deleteData = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(path, id) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _axios.default.delete("http://127.0.0.1:3000/v1/admin/".concat(path, "/").concat(id));
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Kayıt başarıyla silindi. Bekleyiniz...");
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function deleteData(_x6, _x7) {
    return _ref3.apply(this, arguments);
  };
}();

exports.deleteData = deleteData;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"passwordSettings.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "E-mailinize kodunuzu gönderdik. ✅");
              document.querySelector(".btn-forgotPassword").textContent = "Bekleyiniz..";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:3000/v1/admin/kullanici/sifremiYenile/".concat(token),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Şifreniz başarıyla oluşturuldu!");
              window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"contactMail.js":[function(require,module,exports) {
"use strict";
...
var contactMail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, subject, email, message) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Mesajınız Başarıyla Gönderildi ✅");
              window.setTimeout(function () {
                location.reload();
              }, 2500);
            }
  ...
  return function contactMail(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var _adminPanelData = require("./adminPanelData");
...
var loginForm = document.querySelector(".card__form");
var logOutBtn = document.querySelector(".admin__panel--item-logout");
var btnx = document.querySelectorAll(".btn-x");
var commentForm = document.querySelector("#comments");
var announcmentForm = document.querySelector("#announcments");
var contactForm = document.querySelector("#contact");
var mainSliderForm = document.querySelector("#mainSlides");
var galleryForm = document.querySelector("#galleries");
var passwordForm = document.querySelector("#updateMyPassword");
var deletingForm = document.querySelector("#delete");
var forgotPasswordForm = document.querySelector("#forgotForm");
var resetPasswordForm = document.querySelector("#resetForm");
...
if (commentForm) {
  commentForm.addEventListener("submit", function (e) {
    ...
    if (photo === undefined) {
      (0, _alerts.showAlert)("error", "Bir fotoğraf girmelisiniz..");
    } else {
      form.append("photo", photo);
      (0, _adminPanelData.createData)(form, "yorumlar");
    }
  });
}

if (announcmentForm) {
  announcmentForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var creator = document.getElementById("creator").value;
    var subject = document.getElementById("subject").value;
    var announcment = document.getElementById("announcment").value; //createAnnouncment(creator, subject, announcment);

    (0, _adminPanelData.createData)({
      creator: creator,
      subject: subject,
...
if (mainSliderForm) {
  mainSliderForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var form = new FormData();
    ...
    if (photo === undefined) {
      ...
      form.append("photo", photo);
      (0, _adminPanelData.createData)(form, "anaSlayt");
    }
  });
}
...
if (galleryForm) {
  galleryForm.addEventListener("submit", function (e) {
    ...
    if (photo === undefined) {
      ...
      form.append("photo", photo);
      (0, _adminPanelData.createData)(form, "galeri");
    }
  });
}
...
if (passwordForm) {
  passwordForm.addEventListener("submit", function (e) {
    ...
    (0, _adminPanelData.updateData)(passwordCurrent, password, passwordConfirm);
  });
}
...
if (deletingForm) {
  btnx.forEach(function (btn) {
    ...
    var path = window.location.pathname.slice(7); //returns after /admin. Ex:duyurular,yorumlar

    btn.addEventListener("click", function () {
      (0, _adminPanelData.deleteData)("".concat(path), id);
    });
  });
}
...
if (contactForm) {
  contactForm.addEventListener("submit", function (e) {
    e.preventDefault();
    document.querySelector(".contact__form--button").textContent = "Bekleyiniz..";
    ...
    (0, _contactMail.contactMail)(name, subject, email, message);
  });
}
